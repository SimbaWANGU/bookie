...
const Author: React.FC<AuthorProps> = ({
  uri = 'https://art.rtistiq.com/en-us/_next/image?url=https%3A%2F%2Fd28jbe41jq1wak.cloudfront.net%2FBlogsImages%2Fabstract_art_Compressed_638250928944386407.jpg&w=1920&q=75',
  name,
  id,
}) => {
  ...
  return (
    <View style={tw`flex flex-row gap-2 bg-transparent mb-4`}>
      <Image source={{ uri }} style={tw`h-10 aspect-square rounded-full`} />
